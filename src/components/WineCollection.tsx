...
const WineCollection = () => {
  ...
  return (
    <section id="wines" className="py-20 wine-gradient">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-12">
          <button className="bg-gold hover:bg-gold/90 text-charcoal font-inter font-semibold px-8 py-3 rounded-md transition-colors duration-300">
